...
package com.github.shannah.oaitest51;
 ...
 * @author Shai Almog
 */
public class OaiTest51Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Oai Test 51";
    private static final String APP_NAME = "oai-test-51";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new OaiTest51Stub());
    }
